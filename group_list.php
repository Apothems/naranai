...
<div id="main">
    ...
    <div id="content">
        ...
        <div id="alert" style="display:block;">
    		Groups are meant to collect sets of images (such as pages of a doujin) into manageable, easy to find... groups.
	    </div>
        <div class="spacer"></div>
    		<?php
				...
				{	
					...
					$count	 = $run_pop['count'];
					$sql_pop = "SELECT g.image_id, i.hash FROM image_groups g LEFT OUTER JOIN images i ON g.image_id = i.id WHERE group_id = " . $run['id'] . " ORDER BY image_id DESC LIMIT 1";
					$get_pop = mysql_query($sql_pop);
					$run_pop = mysql_fetch_assoc($get_pop);
					echo '
